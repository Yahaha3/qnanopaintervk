...
public:
    ...
    void opengl_init_create();
#ifdef BUILD_VULKAN_BACKENDS
    void vulkan_init_create(QVulkanInstance* instance, QVulkanWindow* window);
#endif
    enum PathWinding {
    ...
    void draw_polygon(const QVector<QPoint>& vertices);
    ...
    void updateImage(QNanoImage &image);
